...
mkdir 'app' && cd ./app && touch index.ts && cd ../;
mkdir 'processes' && cd ./processes && touch index.ts && cd ../;
mkdir 'pages' && cd ./pages && touch index.ts && cd ../;
mkdir 'widgets' && cd ./widgets && touch index.ts && cd ../;
mkdir 'features' && cd ./features && touch index.ts && cd ../;
mkdir 'entities' && cd ./entities && touch index.ts && cd ../;
mkdir 'shared' && cd ./shared && touch index.ts && cd ../;
